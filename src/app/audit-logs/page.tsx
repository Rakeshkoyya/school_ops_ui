  ...
  const mockLogs: AuditLog[] = [
    {
      ...
      user: { id: '1', name: 'John Admin', email: 'john@school.edu', created_at: '', updated_at: '' },
    ...
    },
    {
      ...
      user: { id: '2', name: 'Sarah Teacher', email: 'sarah@school.edu', created_at: '', updated_at: '' },
    ...
    },
    {
      ...
      user: { id: '3', name: 'Mike Coordinator', email: 'mike@school.edu', created_at: '', updated_at: '' },
